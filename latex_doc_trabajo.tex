...
\begin{center}
\includegraphics[width=.7\textwidth]{graf7.pdf}
\vspace{-.75em}
\captionof{figure}[Ejemplo de un proceso de espacio de estado]{Ejemplo de un proceso de espacio de estado. En \thetaline se representa el proceso \textit{no-observable}, en \yeline se representa su observación.}
\label{fig:graf7}
\end{center}
