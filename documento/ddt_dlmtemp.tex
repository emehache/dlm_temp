...
\hlstd{modPoly} \hlkwb{<-} \hlkwd{dlmMLE}\hlstd{(y,}\hlkwc{parm} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{),}\hlkwc{build} \hlstd{= parMLE)}
\hlstd{mod_filter} \hlkwb{<-} \hlkwd{dlmFilter}\hlstd{(y,} \hlkwd{parMLE}\hlstd{(modPoly}\hlopt{$}\hlstd{par))}
\hlstd{mof_filter}\hlopt{$}\hlstd{m}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{parMLE} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{par}\hlstd{)}  \hlkwd{dlmModTrig}\hlstd{(}\hlkwc{s} \hlstd{=} \hlnum{365}\hlstd{,}\hlkwc{q}\hlstd{=}\hlnum{2}\hlstd{,} \hlkwc{dV} \hlstd{= par,} \hlkwc{dW} \hlstd{=} \hlnum{0}\hlstd{)}
\hlstd{mod}\hlkwb{<-} \hlkwd{dlmMLE}\hlstd{(y,}\hlkwc{parm} \hlstd{=} \hlnum{16}\hlstd{,}\hlkwc{build}\hlstd{= parMLE)}
\hlstd{Tn.filter} \hlkwb{<-} \hlkwd{dlmFilter}\hlstd{(y,}\hlkwd{parMLE}\hlstd{(mod}\hlopt{$}\hlstd{par))}
\end{alltt}
\end{kframe}
\end{knitrout}
